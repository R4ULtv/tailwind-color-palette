...
export default function ShortCutMenu() {
  ...
  return (
    <DropdownMenu>
      <DropdownMenuTrigger className="flex items-center gap-0.5 outline-hidden select-none group border border-transparent px-2 py-1.5 rounded-lg hover:border-zinc-600 transition duration-150">
